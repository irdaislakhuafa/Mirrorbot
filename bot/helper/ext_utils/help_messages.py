...
<b>NOTES:</b>
Check all yt-dlp api options from this <a href='https://github.com/yt-dlp/yt-dlp/blob/master/yt_dlp/YoutubeDL.py#L184'>FILE</a> or use this <a href='https://t.me/AYATOPROJECT'>script</a> to convert cli arguments to api options.
"""
